...
public class TestUtil {
  ...
  public static final int RESPONSE_CODE_200 = 200; // successful API request OK
  public static final int RESPONSE_CODE_201 = 201; // created data
  public static final int RESPONSE_CODE_401 = 401; // Unauthorized
  public static final int RESPONSE_CODE_404 = 404; // not found
