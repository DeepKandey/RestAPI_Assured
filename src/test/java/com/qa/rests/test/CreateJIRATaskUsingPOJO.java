...
public class CreateJIRATaskUsingPOJO extends TestBase {
  ...
  public void createTaskInJiraUsingCookie() throws JsonProcessingException {
    ...
    String jsonRequestBody =
        objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(createJIRATask);
    ...
    Response issueResponse =
        RestAssured.given()
            ...
            .post(prop.getProperty("ServiceUrlToCreateIssue"));

    System.out.println(
        "Response Body for task created in JIRA: " + issueResponse.body().jsonPath().prettify());
