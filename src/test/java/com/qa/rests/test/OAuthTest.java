...
public class OAuthTest {
  ...
  public void postTweet() {
    ...
    RequestSpecification oAuthRequestSpecification =
        authenticationSpecification.oauth(
            "rcXYPa3ic1bBtwTXsJ2u7G9op",
            "wK8FvQeIrmkunpvjLFSjcPCjbQu8HoNbi9816Gf5WEJl1iqeZR",
            "832787898-mYoOZUWsUiAPQedQetCDld9FkTDAy1u2z5NSKMzI",
            "KvHxbZaOyfKMmmCVeIzPLPQuLKoNKZbpbUP12UG9Wo");

    // 4. POST the request
    Response oAuthResponse2 =
        oAuthRequestSpecification.request(
            Method.POST,
    ...
    // 9. Destroy Tweet
    RequestSpecification oAuthRequestSpecificationForDelete =
        authenticationSpecification.oauth(
            "rcXYPa3ic1bBtwTXsJ2u7G9op", "wK8FvQeIrmkunpvjLFSjcPCjbQu8HoNbi9816Gf5WEJl1iqeZR",
            "832787898-mYoOZUWsUiAPQedQetCDld9FkTDAyu2z5NSKMzI",
                "KvHxbZaOyfKMmmCVeIzPLPQBuLKoNKZbpbUP12UG9Wo");

    Response oAuthresponseForDelete =
        oAuthRequestSpecificationForDelete.request(
            Method.POST, "https://api.twitter.com/1.1/statuses/destroy/" + tweetId + ".json");

    // 10. Response code when deleted tweet
    System.out.println(
        "Response Code for deleting tweet:--> " + oAuthresponseForDelete.getStatusCode());
  }
}
